...
export default function Hero() {
  return (
    <div className='font-[Montserrat] flex flex-col justify-center items-center px-25 text-center space-y-5 text-[#2C3640] bg-[#F2F6EB] h-[calc(100vh-5rem)]'>
      ...
      <button className='bg-[#2C3640] text-[#F2F6EB] hover:bg-[#F2F6EB] hover:text-[#2C3640] border-2 border-transparent hover:border-[#2C3640] px-8 py-3 font-bold cursor-pointer'>
        Let's Talk
      </button>
